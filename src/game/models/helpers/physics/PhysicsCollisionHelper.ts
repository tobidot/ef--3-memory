...
export class PhysicCollisionHelper {
     ...
     * @param distance The distance between positions that is already calculated
     */
    public static get_overlaping_vector(source: ObjectModel, other: ObjectModel, distance2?: number): null | Vector2 {
        ...
        const needed_distance2 = (source.collision_radius + other.collision_radius) * (source.collision_radius + other.collision_radius);
     ...
     */
    public static get_overlap_on_seperating_axis(axis: Vector2, source: Rect, other: Rect): number | null {
    ...
    public static get_projection_range_on_axis_for_rect(axis: Vector2, rect: Rect): ObjectToVectorPrjectionRange | null {
        return rect.get_corners().reduce<null | ObjectToVectorPrjectionRange>((result: null | ObjectToVectorPrjectionRange, next_point: Vector2I) => {
